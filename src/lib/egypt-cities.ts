...
const GOVERNORATES: EgyptGovernorate[] = [
  {
    ...
    places: [
      ...
      { name: 'مدينتي', lat: 30.157, lng: 31.713 },
      { name: 'الشروق', lat: 30.117, lng: 31.633 },
      { name: 'الرحاب', lat: 30.088, lng: 31.563 },
      { name: 'مدينة بدر', lat: 30.1392, lng: 31.7281 },
      { name: 'السيدة زينب', lat: 30.033, lng: 31.24 },
      { name: 'زهراء المعادي', lat: 29.955, lng: 31.259 },
    ],
  },
  {
    name: 'الجيزة',
    ...
    places: [
      ...
      { name: 'حدائق أكتوبر', lat: 29.975, lng: 30.926 },
  ...
  },
  {
    ...
    places: [
      ...
      { name: 'سموحة', lat: 31.228, lng: 29.942 },
      { name: 'الإبراهيمية', lat: 31.212, lng: 29.926 },
  ...
  },
  {
    ...
    places: [
      ...
      { name: 'الساحل الشمالي', lat: 30.84, lng: 28.95 },
