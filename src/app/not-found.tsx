  ...
  return (
    <>
      ...
      <main className="mx-auto flex min-h-[60vh] max-w-5xl flex-col items-center justify-center px-4 py-20 text-center">
        ...
        <h1 className="mt-4 text-2xl font-extrabold text-[var(--color-text)]">هذه الصفحة غير موجودة</h1>
        ...
        <Link
          href="/"
          className="mt-8 rounded-full bg-[var(--color-accent)] px-7 py-3 text-sm font-bold text-[var(--color-primary-dark)] transition-all hover:scale-[1.03] hover:bg-[var(--color-accent-dark)] hover:shadow-lg"
        >
          العودة للرئيسية
        </Link>
      </main>
